    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .value{
            ...
            color:var(--stat-num); background:none; -webkit-text-fill-color:currentColor;
            margin-bottom:6px;
        }
        ...
        .stat-value { font-size:2.1rem; font-weight:800; line-height:1.1;
            color:var(--stat-num); background:none; -webkit-text-fill-color:currentColor; margin-bottom:6px; }
        ...
        item.innerHTML =
            '<div style="width: 100%;">' +
                ...
                '<div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px; margin-bottom: 15px;">' +
                    '<div style="padding: 15px; background: #2a2a2a; color: #e7eef7; border-radius: 8px; border: 1px solid #404040;">' +
        ...
        try {
            ...
            filesList.innerHTML = allItems.map(item => {
                ...
                return '<div class="result-item">' +
                    ...
                    '<summary style="cursor: pointer; color: var(--brand); font-size: 0.9em;">Show files</summary>' +
